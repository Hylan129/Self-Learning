...
label.place(width = 280,height = 90)
label2 = tkinter.Label(root,font = ('微软雅黑',20),bg = '#EEE9E9',bd ='9',fg = 'black',anchor = 'se',textvariable = result)
label2.place(y = 90,width = 280,height = 60)
...
def pressEqual():
    ...
    if(int(endNum)-99999999999)>0:
        endNum = "Beyond Screen"
    else:
